...
#define DDRC_TIMING2_TRFC_BIT_60b         24 /* AUTO-REFRESH command period. */
...
#define __cpm_start_me()	(REG_CPM_CLKGR1 &= ~CPM_CLKGR1_ME)
#define __cpm_start_dblk()	(REG_CPM_CLKGR1 &= ~CPM_CLKGR1_DBLK)
#define __cpm_start_mc()	(REG_CPM_CLKGR1 &= ~CPM_CLKGR1_MC)
